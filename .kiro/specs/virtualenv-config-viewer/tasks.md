...
- [x] 1. Set up project structure and build system
  - [x] 1.1 Create top-level Makefile with lint, test, and build targets
  ...
  - [x] 1.2 Create Python project scaffolding
  ...
  - [x] 1.3 Create Rust project scaffolding
  ...
  - [x] 1.4 Create Go project scaffolding
...
- [x] 2. Implement Virtualenv Detector (all languages)
  - [x] 2.1 Implement Virtualenv Detector in Python
  ...
  - [x] 2.2 Write unit tests for Python Virtualenv Detector
  ...
  - [x] 2.3 Implement Virtualenv Detector in Rust
  ...
  - [x] 2.4 Write unit tests for Rust Virtualenv Detector
    - Test detection priority chain with temp directories
    - Test error cases and validation logic
    - _Requirements: 1.1, 1.2, 1.3, 1.4, 1.5, 1.6, 1.7_

  - [x] 2.5 Implement Virtualenv Detector in Go
  ...
  - [x] 2.6 Write unit tests for Go Virtualenv Detector
    - Test detection priority chain with temp directories
    - Test error cases and validation logic
    - _Requirements: 1.1, 1.2, 1.3, 1.4, 1.5, 1.6, 1.7_

- [x] 3. Implement Config Reader (all languages)
  - [x] 3.1 Implement Config Reader in Python
  ...
  - [x] 3.2 Write unit tests for Python Config Reader
  ...
  - [x] 3.3 Implement Config Reader in Rust
  ...
  - [x] 3.4 Write unit tests for Rust Config Reader
    - Test reading valid config files and graceful missing file handling
    - _Requirements: 2.1, 2.2, 2.3, 2.4, 2.5, 2.6_

  - [x] 3.5 Implement Config Reader in Go
  ...
  - [x] 3.6 Write unit tests for Go Config Reader
    - Test reading valid config files and graceful missing file handling
    - _Requirements: 2.1, 2.2, 2.3, 2.4, 2.5, 2.6_

- [x] 4. Implement Shell Analyzer (all languages)
  - [x] 4.1 Implement Shell Analyzer in Python
  ...
  - [x] 4.2 Write unit tests for Python Shell Analyzer
  ...
  - [x] 4.3 Implement Shell Analyzer in Rust
...
- [x] 6. Implement App Options / Configuration (all languages)
  - [x] 6.1 Implement App Options in Python
  ...
  - [x] 6.2 Write unit tests for Python App Options
  ...
  - [x] 6.3 Implement App Options in Rust
  ...
  - [x] 6.4 Write unit tests for Rust App Options
    - Test precedence logic
    - _Requirements: 6.2, 6.3, 6.4, 6.5, 6.6_

  - [x] 6.5 Implement App Options in Go
  ...
  - [x] 6.6 Write unit tests for Go App Options
    - Test precedence logic
    - _Requirements: 6.2, 6.3, 6.4, 6.5, 6.6_

- [x] 7. Implement TUI Controller and Navigation (all languages)
  - [x] 7.1 Implement TUI Controller and Navigation in Python
  ...
  - [x] 7.2 Implement TUI Controller and Navigation in Rust
  ...
  - [x] 7.3 Implement TUI Controller and Navigation in Go
...
- [x] 8. Implement Editor Launcher (all languages)
  - [x] 8.1 Implement Editor Launcher in Python
  ...
  - [x] 8.2 Implement Editor Launcher in Rust
  ...
  - [x] 8.3 Implement Editor Launcher in Go
    - Create `go/internal/editor/editor.go`
    - Use `os/exec` to spawn editor
    - Same logic: check EDITOR, check file exists, record mtime, suspend/resume TUI, compare mtime
    - _Requirements: 5.1, 5.2, 5.3, 5.4, 5.5, 5.6_

- [x] 9. Implement Restart Handler (all languages)
  - [x] 9.1 Implement Restart Handler in Python
  ...
  - [x] 9.2 Implement Restart Handler in Rust
    - Create `rust/src/restart.rs` module
    - Same deactivate/reactivate logic with success/failure messages
    - _Requirements: 6.1, 6.7_

  - [x] 9.3 Implement Restart Handler in Go
    - Create `go/internal/restart/restart.go`
    - Same deactivate/reactivate logic with success/failure messages
    - _Requirements: 6.1, 6.7_

- [x] 10. Checkpoint - Full feature validation
  - Ensure all tests pass, ask the user if questions arise.

- [x] 11. Wire entry points and integrate all components
  - [x] 11.1 Wire Python entry point
...
- [x] 13. Lint all codebases and resolve all warnings/errors
  - Run `make lint` from the repository root to lint Python, Rust, and Go codebases
  - Fix all lint errors and warnings reported by each language's linter:
    - Python: `ruff check`, `ruff format --check`, `mypy`
    - Rust: `cargo clippy -- -D warnings`, `cargo fmt --check`
    - Go: `golangci-lint run ./...`
  - Iterate until `make lint` exits with status 0 and produces no warnings or errors
  - _Requirements: 9.2_
